...
# Captions indexes list
train_idx_list = list(captions_dataset["ID_Caption"].values)

# The test set contains the 20% of the total captions
num_instances_test = round(len(train_idx_list)/100*20)
test_idxs_list = []
...
test_capptions_collection = captions_dataset[captions_dataset["ID_Caption"].astype(int).isin(test_idxs_list)]
train_captions_collection = captions_dataset[captions_dataset["ID_Caption"].astype(int).isin(train_idx_list)]
...
test_name = str(k_fold_cross_iteration) + "_test_captions.xlsx"
train_name = str(k_fold_cross_iteration) + "_train_captions.xlsx"
train_txt_name = str(k_fold_cross_iteration) + "_train_captions.txt"
